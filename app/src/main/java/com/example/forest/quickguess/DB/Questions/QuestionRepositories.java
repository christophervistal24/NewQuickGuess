...
//Found
        this.questionCreator("What is help in computer?","Helps the user understand its capabilities","Destroy the system","Increase the run speed","All of the above","Helps the user understand its capabilities","A help system (sometimes called a help file ) is a documentation component of a software program that explains the features of the program and helps the user understand its capabilities.","e_t_13.webp",7,1);
//Found
...
//Found
        this.questionCreator("Software bought to do common jobs like play a game, allow people to speak to each other, record music, view videos, listen to music, play DVDs","Application software","Web browser software","Word processor","Database programs","Application software","An application software (app or application for short) is computer software designed to perform a group of coordinated functions, tasks, or activities for the benefit of the user.","e_t_29.webp",7,1);
//Found
...
//Found
        this.questionCreator("For drawing and designing of homes, buildings, planes, and machineries","Computer aided design (cad)","Web page authoring program","Graphics software","Spreadsheets program","Computer aided design (cad)","CAD (computer-aided design) software is used by architects, engineers, drafters, artists, and others to create precision drawings or technical illustrations. CAD software can be used to create two-dimensional (2-D) drawings or three-dimensional (3-D) models.","e_t_36.webp",7,1);
//Found
...
//Found
        this.questionCreator("Who invented the first computer?","Charles Babbage","Bill Gates","Steve Jobs","Alan Turing","Charles Babbage","We could argue that the first computer was the abacus or its descendant, the slide rule, invented by William Oughtred in 1622. But the first computer resembling today\\\'s modern machines was the Analytical Engine, a device conceived and designed by British mathematician Charles Babbage between 1833 and 1871.","e_t_43.webp",7,1);
//Found
...
//Found
        this.questionCreator("Rediff.com was founded by.....","Ajith Balakrishnan","Āryāvarta Balakrishnann","Jambudvīpa Tianzhu","Hodu Nābhivarṣa","Ajith Balakrishnan","Ajit Balakrishnan is an Indian entrepreneur, business executive and administrator. He is the founder, current Chairman and Chief Executive Officer of Rediff.com, an internet company based in Mumbai.","m_t_12.webp",7,2);
//Found
...
//Found
        this.questionCreator("World\\\'s first microprocessor is .....","Intel 4004","Intel 4002","Intel 4001","Intel 4003","Intel 4004","The Intel 4004 was followed in 1972 by the Intel 8008, the world\\\'s first 8-bit microprocessor.","m_t_18.webp",7,2);
//Found
...
//Found
        this.questionCreator("Who is Netizen ?","Net Citizen (Citizen who uses internet)","Peoples","Geeks","Nerds","Net Citizen (Citizen who uses internet)","The term netizen is a portmanteau of the words Internet and citizen as in \"citizen of the net\". It describes a person actively involved in online communities or the Internet in general.","m_t_28.webp",7,2);
//Found
...
//Found
        this.questionCreator("What is the Earth’s primary source of energy?","The Sun","The Sun","The milkyway","The galaxy","The Sun","The Sun is the primary source of energy for Earth\\\'s climate system is the first of seven Essential Principles of Climate Sciences. Principle 1 sets the stage for understanding Earth\\\'s climate system and energy balance. The Sun warms the planet, drives the hydrologic cycle, and makes life on Earth possible.","m_t_42.webp",7,2);
//Found
